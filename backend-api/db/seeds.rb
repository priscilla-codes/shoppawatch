...
[
  {
    ...
    description: {
      ...
      main:
        "From an inky matte dial to brushed jet steel, Nate gives the all-black trend new depth. Use it to dress up your favorite pair of denim and a crisp, white tee. This Nate watch also features a chronograph movement on a stainless steel bracelet. For a bold, oversized look that is certain to be noticed, choose Nate. Its clean, military-inspired design with oversized lugs and bold details offers a laid-back yet rugged feel that is perfect for any adventure, day or night.",
      specs: [
      ...
      details:
        "There is no better way to keep your favorite looks fresh than with our swappable, versatile watch straps. Our quick release pins allow you to change up your look as often as you like while maintaining your signature style."
    },
    price: 98.99
  },
  {
  ...
  {
    name: "Fossil Townsman Stainless Steel and Leather Casual Quartz Chronograph Watch",
    brand: "Fossil",
    description: {
      summary:
  ...
  },
  {
    ...
    description: {
      summary:
        "Apple Watch Series 5 has a display that is always on, showing the time and important information—no need to raise your wrist.",
      main:
        "Apple Watch Series 5 has a display that is always on, showing the time and important information—no need to raise your wrist. It helps you navigate with the built-in compass. Lets you check on your heart with the ECG app.1 Tracks your workouts and activity. And makes it easy to connect with the people and information you care about, right from your wrist.",
      specs: [
        "3ATM: withstands splashes or brief immersion in water but not swimming or bathing",
        "5 ATM: wearable around household sinks or while swimming in shallow water",
        "Our high-quality leather is known for its softness and ability to look good over time.",
  ...
  },
  {
    ...
    description: {
      ...
      main:
        "The Fossil Nate JR1401 Chronograph Wristwatch for men is as versatile as it is beautiful. The dial has a tough coating, and the bands are constructed out of a stainless steel material. If you wear one of these watches, everyone will notice its face. You will never have problems reading the time.",
      specs: [
  ...
  },
  {
    ...
    description: {
      ...
      details:
        "Fossil has always been inspired by creativity and ingenuity. We have strived to bring new life into the industry by making quality, fashionable watches and accessories that are both fun and accessible."
    },
    price: 79.99
  }
].each_with_index do |product_attrs, index|
  product = Product.new(product_attrs)
  
  if index < file_names.length
    product.main_image.attach(
      io: File.open(Rails.root.join("public", "images", file_names[index])),
